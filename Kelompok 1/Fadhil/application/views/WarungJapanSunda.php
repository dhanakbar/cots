...
<html>
	...
	<nav class="custom-navbar navbar-expand-xl">
        ...
        <header>
            <img src="<?= base_url()?>assets/img/slider/4.png" alt="bg makanan"
		...
		<main class="container mt-5 mb-5" style="background-color:white;">
			<div class="row">
				<?php foreach ($produk as $produk): if($produk->jenis_produk == "Warungjapansunda"){
					$_SESSION['jenisproduk'] = "WarungJapanSunda";
					?>
				<div class="col-lg-3">
					<img  src="<?= base_url()?>assets/img/Warung japan Sunda/<?= $produk->foto_produk; ?>">
					<h4><?= $produk->nama_produk; ?></h4>
                    <h5>Rp. <?= $produk->harga_produk; ?> </h5><?php if(strlen($produk->nama_produk)<= 16){echo '<br><br>';}else{echo '<br>';}?>
