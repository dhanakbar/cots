	...
	<nav class="custom-navbar navbar-expand-xl">
		...
		<img src="<?= base_url()?>assets/img/logoMenuMaster.png" style="height:50px; width: 50px;">
				<a class="custom-navbar-brand  ml-auto " style="width: 69%;" href="Beranda">MenuMaster</a>
					...
					<ul class="navbar-nav ml-3">
						<li class="nav-item">
							<a class="nav-link" href="Keranjang/cek_keranjang/<?= isset($_SESSION['id_pengguna']);?>">Keranjang</a>
						</li>
					</ul>
					<ul class="navbar-nav ml-3">
						<li class="nav-item">
        ...
        <header>
            <img src="<?= base_url()?>assets/img/slider/3.png" alt="bg makanan"
		...
		<main class="container mt-5 mb-5" style="background-color:white;">
			<div class="row">
				<?php foreach ($produk as $produk): if($produk->jenis_produk == "WarungWagyu"){
					$_SESSION['jenisproduk'] = "WarungWagyu";
					?>
				<div class="col-lg-3">
					<img style="width: 500px; height: 250px;" src="<?= base_url()?>assets/img/Warung Wagyu/<?= $produk->foto_produk; ?>">
					<h4><?= $produk->nama_produk; ?></h4>
                    <h5>Rp. <?= $produk->harga_produk; ?> </h5><?php if(strlen($produk->nama_produk)< 18){echo '<br><br>';}else{echo '<br>';}?>
					<a href="Keranjang/insertProduk/<?= $produk->id_produk;?>">
						<button style="background-color: #de0606; font-size: large; color: #ffffff;">BELI DIMARI BRO!!!</button><br>
					</a>
				...
				<div class="pembayaran">
					...
					<table>
						<tr>
							...
							<td>
								<img src="<?= base_url()?>assets/img/logoPembayaran/logoBCA.png" style="width: 500px; height: 100px;">
							</td>
							<td>
						...
						<tr>
							<td>
								<img src="<?= base_url()?>assets/img/logoPembayaran/logoMandiri.png" style="width: 500px; height: 60px;">
							</td>
							<td>
								<img src="<?= base_url()?>assets/img/logoPembayaran/logoDANA.png" style="width: 500px; height: 60px;">
							</td>
							<td>
								<img src="<?= base_url()?>assets/img/logoPembayaran/logoOVO.png" style="width: 500px; height: 60px;">
							</td>
						</tr>
					</table>
				</div>
